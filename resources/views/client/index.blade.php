...
@if(config('app.keyboard_nav'))
<link href="{{asset('/assets/css/votrite-a11y.css')}}" rel="stylesheet" type="text/css"/>
@endif
<style>
    ...
    <form class="login-form" action="{{url('client/sendpincode')}}" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input id="pincode" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Please enter your pincode" name="pincode" aria-label="Pincode" required autofocus/>
			</div>
		</div>
