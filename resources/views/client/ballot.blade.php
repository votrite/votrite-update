...
<div class="page-header-voter -i navbar navbar-fixed-top">
	<div class="page-header-inner row">
        ...
        <div class="voter-title col-md-6 col-xs-12 text-center">
            <h2 id="ballot-title" data-a11y-heading tabindex="-1">Choose Active Ballot</h2>
        </div>
...
<div class="page-container">
	<div class="page-content-wrapper" style="background-color: #e0e5ec;">
		<div class="page-content-fullwidth">
            ...
            <form class="col-md-4 scroller ballot-voter" role="radiogroup" aria-labelledby="ballot-title" method="get" action="{{ url('/client') }}" style="height: 60%;">
                @if($ballots != null)
