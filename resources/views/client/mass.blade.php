		...
		<div class="page-content-fullwidth" style="margin-top: 128px;">
            <div class="col-md-4 col-xs-12">
                <div class="guide-desc-header">
                    <h2 data-a11y-heading tabindex="-1">{{$ballots->data[0]->board}}</h2>
                </div>
                <div class="guide-desc-body" data-a11y-instructions>
                <h4>To vote, select "YES" or "NO" or "FOR" or "AGAINST". You can use the mouse, or the keyboard: press F to select the highlighted answer and K to clear it. A check mark will appear to confirm your selection. When you are done, press J or the "Next" button to continue. Press the "Skip" button to skip.</h4>
                </div>
            </div>
            <div class="col-md-8 col-xs-12">
                <form class="guide-desc-body race-voter" method="post" action="{{ url('client/masscount') }}" style="height: 60%;">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="form-group row" style="margin-left: 20px;" role="group" aria-label="{{$prop->prop_title}}">
