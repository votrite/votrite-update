...
<div class="page-header-voter -i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
        ...
        <div class="voter-title">
            <h2 id="lang-title" data-a11y-heading tabindex="-1">Choose Language</h2>
...
<div class="page-container">
	...
	<div class="page-content-wrapper" style="background-color: #e0e5ec;">
		<div class="page-content-fullwidth">
            ...
            <form class="col-md-4 scroller ballot-voter" role="radiogroup" aria-labelledby="lang-title" method="get" action="{{ url('client/viewcand') }}" style="height: 700px;">
                <!-- @csrf -->
